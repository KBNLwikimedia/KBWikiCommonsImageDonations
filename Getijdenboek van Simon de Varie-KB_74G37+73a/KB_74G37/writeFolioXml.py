    ...
    for i in range(len(data["records"]["record"])):
        if data["records"]["record"][i]["folio"] == folio:
            ...
            if countMiniatures(folio) > 0 : #build <gallery> of minitures
                miniatureString += "File:" + str(miniatureDesc) + " - Book of hours Simon de Varie - KB 74 G37 - " + str(miniatureFile)+ "##" + str(miniatureDesc)+ "\n\n"
...
images_base_url="https://www.kb.nl/kbhtml/simondevarie1/"
...
wikidata = "Q3831825"
browse_entry = "https://galerij.kb.nl/kb.html#/nl/devarie1/page/4/zoom/3/lat/-74.30735341486248/lng/-67.060546875"
...
otherversions = ""
objecthistory = ""
base_titleGWT = "Book of Hours of Simon de Varie - KB 74 G37" # Voor de titel van de File: op Commons
base_title    = "[[:en:Book_of_Hours_of_Simon_de_Varie|Book of Hours of Simon de Varie]] - KB 74 G37" #Titel in de metadata


XMLoutputfile = open("simondevarie_74G37.xml", "w", encoding="UTF-8")
xmlstring=""
