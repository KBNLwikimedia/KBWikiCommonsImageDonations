...
title_overall = "Die Dietsche Doctrinale by [[:nl:Jan van Boendale|Jan van Boendale]], [[:nl:Beatrijs|Beatrijs]], Dit es vanden aflate van Rome, Die heimelicheit der heimelicheden by [[:nl:Jacob van Maerlant|Jacob van Maerlant]] and other texts"
...
modern_translation = "https://www.kb.nl/themas/middeleeuwen/beatrijs/beatrijs-moderne-vertaling-door-willem-wilmink"

#fol. 54v: Ave Maria, Pater noster en Credo uit Der leken spieghel van Jan van Boendale (ca. 1280-1351)
base_titleGWT_4 = "Ave Maria, Pater noster en Credo uit Der leken spieghel"
base_title_4    = "Ave Maria, Pater noster en Credo uit [https://nl.wikipedia.org/w/index.php?title=Jan_van_Boendale&oldid=49455241#Der_leken_spiegel_.28ca._1325-1330.29 Der leken spieghel]"
author_4= "Jan van Boendale (ca. 1280-1351)"
...
base_titleGWT_5 = "Catechetische teksten, o.a. over de tien geboden, over de zeven sacramenten, en over de zeven werken van barmhartigheid (excerpten)"
base_title_5    = "Catechetische teksten, o.a. over de tien geboden, over de zeven sacramenten, en over de zeven werken van barmhartigheid (excerpten)"
author_5= "Jan van Ruusbroec (ca. 1293-1381)"
...
base_titleGWT_6 = "Dit es vanden aflate van Rome"
base_title_6    = "Dit es vanden aflate van Rome"
author_6= ""
...
author_7= "Jacob van Maerlant (1230/35-ca. 1291)"
...
#all illuminations
illumlist=["001r-init","007v-init","033v-init","047v-init","057v-init","061v-init"]
...
for infile in glob.glob(os.path.join(imagedir_hires, '*.jpg')):
    ...
    elif folio in dietselist:
        if folio in illumlist:
            print(str(folio))
        else:
            xmlstring += "    <accessionnumber>*[" + browse_entry_2 + " View this manuscript] on the website of the KB" + "\n*" + "Read [" + homepageNL + " backgroud information in Dutch] and in [" + homepageEN + " English]" + "\n*" + "Description of the entire manuscript in the catalogue of the KB: http://opc4.kb.nl/PPN?PPN=" + ppn + "</accessionnumber>\n"
            xmlstring += "    <description>Paschal table, folium "+ str(folio) +". This text is part of a manuscript also containing " + title_overall + " - " + signature + "</description>\n"
            xmlstring += "    <URLtothemediafile>" + images_base_url_hires + str(picname) + "</URLtothemediafile>\n"
            xmlstring += "    <GWToolsettitle>" + signature + " - Paschal table, folium "+ str(folio) + "</GWToolsettitle>\n"
            xmlstring += "    <title>Paschal table, folium "+ str(folio) +". This table is part of the manuscript containing " + title_overall + " - " + signature + "</title>\n"
            xmlstring += "    <date>" + str(date) + "</date>\n"
